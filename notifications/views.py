...
class NotificationsAjaxView(View):
    ...
    def post(self, request, *args, **kwargs):
        if self.request.is_ajax():
            if self.request.user.is_authenticated:
                ...
                # grab notifications unread list
                # mark all in list as read
                # test: if read, should no longer show notification count nor notifications on the navbar.

                # p = Profile.objects.get(user=user)
                # print("=====")
                # print(user.notifications.unsent())
                # p.save()
